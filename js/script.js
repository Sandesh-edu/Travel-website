...
scrollTriggerAnimation(".travel", [".travel .box"]);
...
swipeAnimation(".destinations", [".destinations .heading"]);

swipeAnimation(".article", [".article .content"]);

galleryAnimation(".destinations .gallery", [".destinations .gallery .box"]);

galleryAnimation(".featured .gallery", [".featured .gallery .box"]);
